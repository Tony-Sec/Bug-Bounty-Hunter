...
![[xss_5.png]]`Storage`en la barra de Herramientas para desarrolladores. Luego hacer clic en el `+`botón de la esquina superior derecha y agregar nuestra cookie, donde  `Name` es `cookie` y `Value` es la nuestra cookie robada , y refrescar la página.