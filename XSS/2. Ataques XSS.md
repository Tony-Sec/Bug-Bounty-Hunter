...
![[Pasted image 20240920215229.jpg]]
...
![[Pasted image 20240920215659.jpg]]
...
![[Pasted image 20240923150538.png]]
...
![[Pasted image 20240923150748.png]]
...
![[Pasted image 20240924142508.png]]`Storage`en la barra de Herramientas para desarrolladores. Luego hacer clic en el `+`botón de la esquina superior derecha y agregar nuestra cookie, donde  `Name` es `cookie` y `Value` es la nuestra cookie robada , y refrescar la página.